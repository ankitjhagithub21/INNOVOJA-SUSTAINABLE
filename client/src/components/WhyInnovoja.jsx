  ...
  return (
    <div className='w-full py-24 why-innovoja text-[var(--clr-dark)] relative'>
      ...
      <div className='lg:w-2/3 mx-auto w-full px-5 lg:px-0'>
        ...
        <Link to={"/about"} className='px-12 py-4 bg-[var(--clr-orange)] rounded-full text-white'>Learn More About Innovoja</Link>
      </div>
    </div>
  )
}
