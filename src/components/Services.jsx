     ...
     <div className='container mx-auto'>
       ...
       <div className='flex flex-wrap lg:w-2/3 w-full mx-auto'>
        ...
        <div className='md:w-1/2 w-full p-5'>
            <img src="https://ionomr.com/wp-content/uploads/2018/10/ionomr-aemion-crop-1-800x878.jpg" alt="" />
        ...
        <div className='md:w-1/2 w-full p-5'>
            <img src="https://ionomr.com/wp-content/uploads/2018/10/ionomr-pemion-crop-1-800x878.jpg" alt="" />
            <div className='bg-[#F4965D] p-5 flex flex-col items-start  gap-5'>
